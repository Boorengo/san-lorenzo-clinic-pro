...
const formTemplates: Record<string, { title: string; columns: ColumnDef[]; defaultData: Record<string, any>[] }> = {
  ...
  "target-list": {
    ...
    columns: [
      ...
      { key: "service", label: "Service Type", type: "select", options: ["Prenatal", "Immunization", "Family Planning", "TB DOTS", "Other"] },
      { key: "dateOfService", label: "Date of Service", type: "date" },
      { key: "status", label: "Status", type: "select", options: ["Completed", "Pending", "Missed"] },
    ],
    defaultData: [],
  },
  "nutrition-report": {
